    ...
    def test_theme_switch(self, driver):
        ...
        try:
            ...
            with allure.step("Wait for the theme toggle to be clickable"):
                ...
                theme_toggle.click()
                allure.attach("Theme toggle is clickable", name="Step 1", attachment_type=allure.attachment_type.TEXT)
            ...
            with allure.step("Verify the theme switch"):
                body_class = WebDriverWait(driver, 10).until(
                    EC.presence_of_element_located(HomePageLocators.BODY)
                ).get_attribute("class")
